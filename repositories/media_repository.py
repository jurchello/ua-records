...
class MediaRepository(
    ...
    def set_checksum(self, obj, text: str) -> None:
        obj.set_checksum(text)

    def set_description(self, obj, text: str) -> None:
        obj.set_description(text)

    def set_mime_type(self, obj, mime_type: str) -> None:
        obj.set_mime_type(mime_type)

    def set_path(self, obj, path: str) -> None:
        obj.set_path(path)
    ...
    def mime_type(self, obj) -> str:
        try:
            return obj.mime_type
        except AttributeError:
            return obj.get_mime_type()

    def path(self, obj) -> str:
        try:
            return obj.path
        except AttributeError:
            return obj.get_path()