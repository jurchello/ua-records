...
from identity.identity_map import IdentityMap, CommitAdapter
...
def _patch_all(plan: CommitPlan, vh_to_h: Dict[str,str], idmap: IdentityMap, adapter: CommitAdapter) -> None:
...
def _delete_all(plan: CommitPlan, idmap: IdentityMap, adapter: CommitAdapter) -> None:
