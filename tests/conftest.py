...
import pytest
from gramps.gen.lib import Citation, Event, Family, Person, Place, Tag
...
class TinyDb:
    ...
    # Person
    def add_person(self, p: Person, _t: Any) -> Handle:
        h = self._h()
        self.people[h] = p
        return h

    def commit_person(self, _p: Person, _t: Any) -> None: ...
    def get_person_from_handle(self, h: Handle) -> Optional[Person]:
    ...
    # Event
    def add_event(self, e: Event, _t: Any) -> Handle:
        h = self._h()
        self.events[h] = e
        return h

    def commit_event(self, _e: Event, _t: Any) -> None: ...
    def get_event_from_handle(self, h: Handle) -> Optional[Event]:
    ...
    # Family
    def add_family(self, f: Family, _t: Any) -> Handle:
        h = self._h()
        self.families[h] = f
        return h

    def commit_family(self, _f: Family, _t: Any) -> None: ...
    def get_family_from_handle(self, h: Handle) -> Optional[Family]:
        return self.families.get(h)

    # Tag
    def add_tag(self, t: Tag, _t: Any) -> Handle:
        h = self._h()
        self.tags[h] = t
        return h

    def commit_tag(self, _t: Tag, _tr: Any) -> None: ...
    def get_tag_from_handle(self, h: Handle) -> Optional[Tag]:
    ...
    # Citation
    def add_citation(self, c: Citation, _t: Any) -> Handle:
        h = self._h()
        self.citations[h] = c
        return h

    def commit_citation(self, _c: Citation, _t: Any) -> None: ...
    def get_citation_from_handle(self, h: Handle) -> Optional[Citation]:
        return self.citations.get(h)

    # Place
    def add_place(self, p: Place, _t: Any) -> Handle:
        h = self._h()
        self.places[h] = p
        return h

    def commit_place(self, _p: Place, _t: Any) -> None: ...
    def get_place_from_handle(self, h: Handle) -> Optional[Place]:
