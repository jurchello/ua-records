...
def test_field_visibility_logic_needed():
    ...
    for i, scenario in enumerate(scenarios, 1):
        ...
        print(f"  Male field: {'visible' if scenario['male_field_visible'] else 'hidden'}, value='{scenario['male_field_value']}'")
        print(f"  Female field: {'visible' if scenario['female_field_visible'] else 'hidden'}, value='{scenario['female_field_value']}'")
